...
public class MazeView extends ProblemView {
	...
	public static final Image hamster2 = Toolkit.getDefaultToolkit().getImage("src/problems/maze/imgs/hamster2.png");
	...
	public MazeView(MazeProblem mazeProblem, int sizePx) {
		...
		scaledHamster = hamster.getScaledInstance((int) (cellSizePx * 0.5), (int) (cellSizePx * 0.5),
				Image.SCALE_SMOOTH);
		scaledHamster2 = hamster2.getScaledInstance((int) (cellSizePx * 0.5), (int) (cellSizePx * 0.5),
				Image.SCALE_SMOOTH);
	...
	private void generateMazeImage() {
		...
		for (int posX = 0; posX < mazeProblem.maze.size; posX++) {
			for (int posY = 0; posY < mazeProblem.maze.size; posY++) {
				...
				RoundRectangle2D cellShape = new RoundRectangle2D.Double(posCellPx.x + 1 + cellBoundsPx[0],
						posCellPx.y + 1 + cellBoundsPx[1], cellSizePx + -1 + cellBoundsPx[2],
						cellSizePx - 1 + cellBoundsPx[3], 10, 10);
